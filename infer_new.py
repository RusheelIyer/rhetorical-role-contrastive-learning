...
def infer(model_path, max_docs, prediction_output_json_path):
    ...
    metrics, confusion, labels_dict, class_report = eval_model(
        model, test_batches, device, task)
...
if __name__ == "__main__":
    ...
    for doc_name, predicted_labels in zip(predictions['doc_names'],
                                          predictions['docwise_y_predicted']):
